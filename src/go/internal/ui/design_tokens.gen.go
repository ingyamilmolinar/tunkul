...
var (
	...
	genColorPrimary                  = color.RGBA{255, 179, 10, 255}  // colors.primary = #FFB30A
	genColorPrimaryBright            = color.RGBA{255, 211, 25, 255}  // colors.primary-bright = #FFD319
	genColorPrimaryDim               = color.RGBA{255, 158, 31, 255}  // colors.primary-dim = #FF9E1F
	...
	genColorOnSurfaceAccent          = color.RGBA{255, 179, 10, 255}  // colors.on-surface-accent = #FFB30A
	...
	genColorVizBar                   = color.RGBA{255, 179, 10, 255}  // colors.viz-bar = #FFB30A
	genColorVizBarPeak               = color.RGBA{255, 233, 138, 255} // colors.viz-bar-peak = #FFE98A
	genColorVizCurve                 = color.RGBA{255, 179, 10, 255}  // colors.viz-curve = #FFB30A
	genColorVizWaveA                 = color.RGBA{255, 211, 25, 255}  // colors.viz-wave-a = #FFD319
	genColorVizWaveB                 = color.RGBA{138, 122, 156, 255} // colors.viz-wave-b = #8A7A9C
	genColorVizMeterLow              = color.RGBA{255, 179, 10, 255}  // colors.viz-meter-low = #FFB30A
	genColorVizMeterMid              = color.RGBA{255, 122, 61, 255}  // colors.viz-meter-mid = #FF7A3D
	genColorVizMeterHigh             = color.RGBA{232, 74, 31, 255}   // colors.viz-meter-high = #E84A1F
	...
	genColorVizGlow                  = color.RGBA{255, 233, 138, 255} // colors.viz-glow = #FFE98A
	...
	genColorSliderFill               = color.RGBA{255, 158, 31, 255}  // colors.slider-fill = #FF9E1F
	genColorSidebarSectionBg         = color.RGBA{56, 35, 84, 255}    // colors.sidebar-section-bg = #382354
	genColorVizScopeTraceA           = color.RGBA{255, 179, 10, 255}  // colors.viz-scope-trace-a = #FFB30A
	genColorVizScopeTraceB           = color.RGBA{255, 122, 61, 255}  // colors.viz-scope-trace-b = #FF7A3D
	...
	genColorSoloActiveBorder         = color.RGBA{255, 211, 25, 255}  // colors.solo-active-border = #FFD319
	genColorFxActiveFill             = color.RGBA{40, 26, 64, 255}    // colors.fx-active-fill = #281A40
	genColorEqFilterActiveFill       = color.RGBA{255, 158, 31, 255}  // colors.eq-filter-active-fill = #FF9E1F
	genColorEqFilterActiveBorder     = color.RGBA{255, 179, 10, 255}  // colors.eq-filter-active-border = #FFB30A
	...
	genColorDrumGlow                 = color.RGBA{255, 179, 10, 255}  // colors.drum-glow = #FFB30A
	...
	genColorSplitterHandle           = color.RGBA{255, 179, 10, 255}  // colors.splitter-handle = #FFB30A
...
var (
	...
	genAnimButtonEngageFlash             = ExpDecayAnim{Rate: 0.82, Threshold: 0.02}                                 // animations.button-engage-flash
...
const (
	...
	genGeomKeycapWallDepth            = 2    // geometry.keycap-wall-depth
	genGeomKeycapActiveRaise          = 1    // geometry.keycap-active-raise
	genGeomKeycapReleaseOvershootFrac = 0.18 // geometry.keycap-release-overshoot-frac
